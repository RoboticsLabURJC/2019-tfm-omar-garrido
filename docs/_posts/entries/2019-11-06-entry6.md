...
In this case range flow (and some ICP from time to time) is the odometry method used in DDS (Direct Depth SLAM). Concretely the appear to 
...
- Kinect Fusion [4]: A lot of derivatives works from this
*KinectFusion implements TSFD[36] and ICP, needs a GPU for real time*

Other references:
- Yousif[37]: real time 3d registration and mappiing, low cost RGBD sensor
...
## Range Flow
Range Flow is a concept which can be used to retrive movement within range consecutive images or range sequences. Its the idea of optical flow
...
These previous read are good to familiarized with the range flow concept but not in a odometry way. All of these lectures are about retrieving 
...
Here they proposed the *elevation rate constraint equation*, better know today as range flow equation.

<img src="/assets/images/entry6_images/range_flow.PNG" alt="Omar Garrido" itemprop="image">
...
<img src="/assets/images/entry6_images/DIFODO_equation_5.PNG" alt="Omar Garrido" itemprop="image">
...
the movement of a point on the surface regarding the sensor movement (which seems to be the opposite). 

<img src="/assets/images/entry6_images/rigid_body_motion_XYZ_equation.PNG" alt="Omar Garrido" itemprop="image"  width="500" height="600"> 
...
<img src="/assets/images/entry6_images/DIFODO_equation_6.PNG" alt="Omar Garrido" itemprop="image">
...
<img src="/assets/images/entry6_images/DIFODO_equation_3.PNG" alt="Omar Garrido" itemprop="image"  width="600" height="600">
<img src="/assets/images/entry6_images/DIFODO_equation_4.PNG" alt="Omar Garrido" itemprop="image"  width="600" height="600">

Finally they substitutes these equations in the equation (6) to get the final equation:

<img src="/assets/images/entry6_images/DIFODO_equation_7.PNG" alt="Omar Garrido" itemprop="image">
